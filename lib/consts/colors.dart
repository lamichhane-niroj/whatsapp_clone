...
const appBarTextColor = Color.fromRGBO(108, 136, 156, 1);
const webAppBarColor = Color.fromRGBO(42, 47, 50, 1);

const messageColor = Color.fromRGBO(3, 97, 84, 1);
const senderMessageColor = Color.fromRGBO(39, 50, 55, 1);
...
const sendColor = Color.fromRGBO(45, 211, 175, 1);
